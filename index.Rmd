...
library(knitr)
opts_chunk$set(out.extra='style="display:block; margin: auto"', fig.align="center",tidy=TRUE,cache=TRUE)
...
```{r, mapplot, message=FALSE, error=FALSE,warning=FALSE }
require(ggmap)
