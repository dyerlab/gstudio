...
#'     \item{pij}{Conditional probability of j given i (p_{j|i}), normalised across i's neighbours.}
#'     \item{pji}{Conditional probability of i given j (p_{i|j}), normalised across j's neighbours.}
